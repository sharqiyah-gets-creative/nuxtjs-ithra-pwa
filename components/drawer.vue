<script lang="ts" setup>
	...
	onMounted(async () => {
		console.log('drawer.vue', 'Drawer vue mounted');
		initFlowbite();
	});
...
<template>
	...
	<Swipe>
		<div
			:id="id"
			class="fixed shadow bottom-0 left-0 right-0 z-50 w-full max-h-screen min-h-[50%] rounded-lg max-w-xl mx-auto overflow-y-auto transition-transform translate-y-full bg-white dark:bg-gray-800 flex flex-col"
			tabindex="-1"
